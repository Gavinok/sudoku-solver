...
def main():
    ...
    with open(puzzle_filename, 'r') as input_file:
        puzzle_contents = input_file.read().replace(" ", "").replace("\n", "")
    ...
    with open(cnf_filename, 'w') as cnf_output:
        cnf_output.write(getBaseEncoding(encoded_with_rows)
